...
pub struct RuleSyntax {
    ...
    #[serde(default)]
    pub character_requirements: Option<CharacterRequirements>,
}
...
impl Rule {
    ...
    pub fn character_requirements(&self) -> Option<&CharacterRequirements> {
        self.syntax.character_requirements.as_ref()
    }
}
...
mod tests {
    ...
    #[test]
    fn test_character_requirements_digits() {
        let reqs = CharacterRequirements {
            min_digits: Some(2),
            min_uppercase: None,
            min_lowercase: None,
    ...
    #[test]
    fn test_character_requirements_uppercase() {
        let reqs = CharacterRequirements {
            min_digits: None,
    ...
    #[test]
    fn test_character_requirements_lowercase() {
        let reqs = CharacterRequirements {
            min_digits: None,
            min_uppercase: None,
    ...
    #[test]
    fn test_character_requirements_special_chars() {
        let reqs = CharacterRequirements {
            min_digits: None,
            min_uppercase: None,
            min_lowercase: None,
    ...
    #[test]
    fn test_character_requirements_custom_special_chars() {
        let reqs = CharacterRequirements {
            min_digits: None,
            min_uppercase: None,
            min_lowercase: None,
    ...
    #[test]
    fn test_character_requirements_combined() {
        let reqs = CharacterRequirements {
            min_digits: Some(1),
    ...
    #[test]
    fn test_character_requirements_none() {
        let reqs = CharacterRequirements {
            min_digits: None,
            min_uppercase: None,
            min_lowercase: None,
